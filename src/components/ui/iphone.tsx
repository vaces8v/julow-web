/**
 * iPhone-mockup. Адаптировано из magicui (https://magicui.design/docs/components/iphone).
 *
 * Сохраняет original-soft-paths и поддерживает src/videoSrc. Размер
 * контролируется внешним wrapper'ом (через `style.width` или классом
 * `w-[280px]`); компонент сам держит aspect-ratio 433/882.
 */
