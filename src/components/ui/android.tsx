/**
 * Android-mockup. Адаптировано из magicui (https://magicui.design/docs/components/android).
 *
 * Принимает width/height (по умолчанию 433×882). Поддерживает src/videoSrc
 * для отображения скриншота/видео внутри экрана. SVG, light/dark-aware.
 */
